...
CLASS_PROFILES: dict[ImageClass, ImageClassProfile] = {
    ImageClass.ICON: ImageClassProfile(
        ...
        allowed_providers=("wikimedia", "openverse", "pixabay"),
        query_terms=("icon", "symbol", "pictogram", "simple vector", "flat icon"),
        clip_context=("simple icon", "minimal symbol", "flat vector mark"),
        preferred_sources={"wikimedia": 1.0, "openverse": 0.96, "pixabay": 0.74, "pexels": 0.0},
    ...
    ImageClass.DIAGRAM: ImageClassProfile(
        ...
        preferred_sources={"wikimedia": 1.0, "openverse": 0.95, "pixabay": 0.68, "pexels": 0.0},
    ...
    ImageClass.ILLUSTRATION: ImageClassProfile(
        ...
        preferred_sources={"wikimedia": 0.98, "openverse": 0.96, "pixabay": 0.78, "pexels": 0.0},
    ...
    ImageClass.PHOTO: ImageClassProfile(
        ...
        allowed_providers=("wikimedia", "openverse", "pexels", "pixabay"),
        ...
        preferred_sources={"wikimedia": 1.0, "openverse": 0.94, "pexels": 0.74, "pixabay": 0.70},
